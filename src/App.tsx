          ...
          <Section id="quiz" icon="🧠" title="Quiz & Prüfung">
            <div className="space-y-2">
              ...
              <div>
                ...
                <p>Beantwortest du eine Frage <span className="text-white font-semibold">5× in Folge richtig</span>, wird sie automatisch mit einem Stern markiert. Gestirnte Fragen tauchen im Practice-Modus <span className="text-white font-semibold">seltener auf</span> — der Stern signalisiert: diese Frage sitzt.</p>
                <p className="mt-1">Du kannst Fragen direkt im Quiz auch manuell markieren.</p>
              </div>
